(function() {
    ...
    sap.ui.mw.DisplayBase.prototype.createCanvas = function(_id) {
        //var canvas = '<canvas id=' + _id + ' width="400" height="400"></canvas>';
        var containerTemp='<div id="' + _id + '" style="width: 100%; height: 250px; margin: 0 auto"></div>';
        var ohtml = new sap.ui.core.HTML({
            preferDOM: true,
            content: containerTemp
        });
        return ohtml;
    };
